...
# direct methods
.method public constructor <init>(LBK;LFv0;)V
    .locals 0
...
.method public h(LuG0;LxH0;)Z
    ...
    invoke-static {p1}, LHv0;->d(LuG0;)LHv0;
    ...
    .line 11
    invoke-direct {v4, v5, p2, v6, v7}, LKv0;-><init>(LBK;LxH0;J)V
    ...
    .line 13
    iput-object p1, p2, LHv0;->b:Lxc0;

    .line 14
    iget-object p1, v2, LUm0;->y:LTm0;
    ...
    invoke-direct {v2, v0, v3, v5, v6}, LeH0;-><init>(IIJ)V

    .line 18
    invoke-virtual {p2, p1, v2}, LZy1;->c(LBK;LeH0;)Lrm1;

    move-result-object p1

    new-instance p2, LJv0;

    invoke-direct {p2, v4}, LJv0;-><init>(LKv0;)V
