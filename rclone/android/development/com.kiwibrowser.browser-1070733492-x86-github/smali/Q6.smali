...
# direct methods
.method public constructor <init>(LBK;LA6;)V
    .locals 0
...
.method public h(LuG0;LxH0;)Z
    ...
    invoke-direct {v4, p1}, LL6;-><init>(I)V
    ...
    iput-object p1, v4, LL6;->b:Ljava/lang/String;
    :try_end_1
    .catchall {:try_start_1 .. :try_end_1} :catchall_0
    ...
    iget-object v2, v4, LL6;->b:Ljava/lang/String;
    ...
    .line 18
    invoke-direct {v4, v5, p2, v6, v7}, LO6;-><init>(LBK;LxH0;J)V

    invoke-interface {p1, v2, v4}, LA6;->S(Ljava/lang/String;LO6;)V
    ...
    .line 31
    invoke-direct {v2, v4, p2, v5, v6}, LK6;-><init>(LBK;LxH0;J)V

    invoke-interface {p1, v2}, LA6;->f0(LK6;)V
