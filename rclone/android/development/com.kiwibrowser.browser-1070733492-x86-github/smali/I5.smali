...
# direct methods
.method public constructor <init>(Landroid/content/Context;Lma;Landroid/view/Window;)V
    .locals 3
    ...
    invoke-direct {v1, p0}, Lx5;-><init>(LI5;)V

    iput-object v1, p0, LI5;->R:Landroid/view/View$OnClickListener;

    .line 6
    iput-object p1, p0, LI5;->a:Landroid/content/Context;

    .line 7
    iput-object p2, p0, LI5;->b:Lma;
    ...
    invoke-direct {p3, p2}, LG5;-><init>(Landroid/content/DialogInterface;)V

    iput-object p3, p0, LI5;->Q:Landroid/os/Handler;

    .line 10
    sget-object p3, LPa1;->e:[I
    ...
    .line 20
    invoke-virtual {p2}, Lma;->a()LS9;

    move-result-object p1

    invoke-virtual {p1, v1}, LS9;->j(I)Z
...
.method public e(ILjava/lang/CharSequence;Landroid/content/DialogInterface$OnClickListener;Landroid/os/Message;Landroid/graphics/drawable/Drawable;)V
    ...
    .line 1
    iget-object p5, p0, LI5;->Q:Landroid/os/Handler;
    ...
    .line 4
    iput-object p4, p0, LI5;->r:Landroid/graphics/drawable/Drawable;
    ...
    .line 8
    iput-object p4, p0, LI5;->v:Landroid/graphics/drawable/Drawable;

    goto :goto_1

    .line 9
    :cond_3
    iput-object p2, p0, LI5;->x:Ljava/lang/CharSequence;

    .line 10
    iput-object p3, p0, LI5;->y:Landroid/os/Message;

    .line 11
    iput-object p4, p0, LI5;->z:Landroid/graphics/drawable/Drawable;
