...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    invoke-direct {p0, p1, p2, v1}, LK9;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;I)V
    ...
    iput-object p1, p0, LWy0;->E:Landroid/graphics/Rect;
    ...
    .line 8
    invoke-virtual {p0, v2}, LK9;->setKeyListener(Landroid/text/method/KeyListener;)V
    ...
    iput-object v1, p0, LWy0;->D:Landroid/view/accessibility/AccessibilityManager;
    ...
    .line 11
    invoke-direct {v1, p1, v2, v3, v0}, LSu0;-><init>(Landroid/content/Context;Landroid/util/AttributeSet;II)V

    .line 12
    iput-object v1, p0, LWy0;->C:LSu0;

    const/4 p1, 0x1

    .line 13
    invoke-virtual {v1, p1}, LSu0;->s(Z)V

    .line 14
    iput-object p0, v1, LSu0;->M:Landroid/view/View;
    ...
    invoke-virtual {v1, p1}, LSu0;->d(Landroid/widget/ListAdapter;)V

    .line 17
    new-instance p1, LVy0;

    invoke-direct {p1, p0}, LVy0;-><init>(LWy0;)V

    .line 18
    iput-object p1, v1, LSu0;->N:Landroid/widget/AdapterView$OnItemClickListener;
...
.method public static a(LWy0;Ljava/lang/Object;)V
    .locals 1
...
.method public getHint()Ljava/lang/CharSequence;
    ...
    .line 1
    invoke-virtual {p0}, LWy0;->b()Lcom/google/android/material/textfield/TextInputLayout;
...
.method public onMeasure(II)V
    ...
    .line 8
    iget-object v5, p0, LWy0;->C:LSu0;

    .line 9
    invoke-virtual {v5}, LSu0;->a()Z
    ...
    .line 20
    :cond_4
    iget-object v0, p0, LWy0;->C:LSu0;

    invoke-virtual {v0}, LSu0;->f()Landroid/graphics/drawable/Drawable;
    ...
    .line 21
    iget-object v2, p0, LWy0;->E:Landroid/graphics/Rect;

    invoke-virtual {v0, v2}, Landroid/graphics/drawable/Drawable;->getPadding(Landroid/graphics/Rect;)Z

    .line 22
    iget-object v0, p0, LWy0;->E:Landroid/graphics/Rect;
...
.method public setAdapter(Landroid/widget/ListAdapter;)V
    ...
    .line 2
    iget-object p1, p0, LWy0;->C:LSu0;

    invoke-virtual {p0}, Landroid/widget/AutoCompleteTextView;->getAdapter()Landroid/widget/ListAdapter;

    move-result-object v0

    invoke-virtual {p1, v0}, LSu0;->d(Landroid/widget/ListAdapter;)V
...
.method public showDropDown()V
    ...
    .line 1
    iget-object v0, p0, LWy0;->D:Landroid/view/accessibility/AccessibilityManager;
