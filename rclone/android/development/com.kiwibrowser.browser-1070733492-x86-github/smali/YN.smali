...
.method public synthetic constructor <init>(Lorg/chromium/chrome/browser/customtabs/CustomTabsConnection;ZLandroidx/browser/customtabs/CustomTabsSessionToken;ILjava/lang/String;Landroid/os/Bundle;Ljava/util/List;)V
    ...
    iput-object p1, p0, LYN;->y:Lorg/chromium/chrome/browser/customtabs/CustomTabsConnection;

    iput-boolean p2, p0, LYN;->z:Z

    iput-object p3, p0, LYN;->A:Landroidx/browser/customtabs/CustomTabsSessionToken;

    iput p4, p0, LYN;->B:I

    iput-object p5, p0, LYN;->C:Ljava/lang/String;

    iput-object p6, p0, LYN;->D:Landroid/os/Bundle;

    iput-object p7, p0, LYN;->E:Ljava/util/List;
...
.method public final run()V
    ...
    iget-object v0, p0, LYN;->y:Lorg/chromium/chrome/browser/customtabs/CustomTabsConnection;

    iget-boolean v1, p0, LYN;->z:Z

    iget-object v2, p0, LYN;->A:Landroidx/browser/customtabs/CustomTabsSessionToken;

    iget v3, p0, LYN;->B:I

    iget-object v4, p0, LYN;->C:Ljava/lang/String;

    iget-object v5, p0, LYN;->D:Landroid/os/Bundle;

    iget-object v6, p0, LYN;->E:Ljava/util/List;
