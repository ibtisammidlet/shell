...
.method public constructor <init>(Landroid/content/Context;I)V
    ...
    invoke-direct {p1, p2, p0, v0}, LI5;-><init>(Landroid/content/Context;Lma;Landroid/view/Window;)V

    iput-object p1, p0, LK5;->A:LI5;
...
.method public c(I)Landroid/widget/Button;
    ...
    .line 2
    :cond_0
    iget-object p1, v0, LI5;->o:Landroid/widget/Button;

    goto :goto_0

    .line 3
    :cond_1
    iget-object p1, v0, LI5;->s:Landroid/widget/Button;

    goto :goto_0

    .line 4
    :cond_2
    iget-object p1, v0, LI5;->w:Landroid/widget/Button;
...
.method public onCreate(Landroid/os/Bundle;)V
    ...
    .line 1
    invoke-super/range {p0 .. p1}, Lma;->onCreate(Landroid/os/Bundle;)V

    move-object/from16 v0, p0

    .line 2
    iget-object v1, v0, LK5;->A:LI5;
    ...
    .line 6
    :goto_0
    iget-object v3, v1, LI5;->b:Lma;

    invoke-virtual {v3, v2}, Lma;->setContentView(I)V
    ...
    .line 12
    iget-object v9, v1, LI5;->h:Landroid/view/View;
    ...
    .line 14
    iget-object v9, v1, LI5;->a:Landroid/content/Context;
    ...
    .line 16
    invoke-static {v9}, LI5;->a(Landroid/view/View;)Z
    ...
    .line 17
    :cond_4
    iget-object v14, v1, LI5;->c:Landroid/view/Window;
    ...
    .line 18
    iget-object v13, v1, LI5;->c:Landroid/view/Window;

    const v12, 0x7f0b020b
    ...
    .line 22
    :cond_6
    iget-object v9, v1, LI5;->g:Landroid/widget/ListView;
    ...
    .line 28
    invoke-virtual {v1, v3, v4}, LI5;->d(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v3

    .line 29
    invoke-virtual {v1, v5, v6}, LI5;->d(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v4

    .line 30
    invoke-virtual {v1, v7, v8}, LI5;->d(Landroid/view/View;Landroid/view/View;)Landroid/view/ViewGroup;

    move-result-object v5

    .line 31
    iget-object v6, v1, LI5;->c:Landroid/view/Window;
    ...
    iput-object v6, v1, LI5;->A:Landroidx/core/widget/NestedScrollView;

    .line 32
    invoke-virtual {v6, v11}, Landroid/widget/FrameLayout;->setFocusable(Z)V

    .line 33
    iget-object v6, v1, LI5;->A:Landroidx/core/widget/NestedScrollView;
    ...
    iput-object v6, v1, LI5;->F:Landroid/widget/TextView;
    ...
    iget-object v7, v1, LI5;->F:Landroid/widget/TextView;

    invoke-virtual {v6, v7}, Landroid/widget/FrameLayout;->removeView(Landroid/view/View;)V

    .line 39
    iget-object v6, v1, LI5;->g:Landroid/widget/ListView;
    ...
    .line 41
    iget-object v7, v1, LI5;->A:Landroidx/core/widget/NestedScrollView;
    ...
    .line 43
    iget-object v8, v1, LI5;->g:Landroid/widget/ListView;
    ...
    iput-object v6, v1, LI5;->o:Landroid/widget/Button;

    .line 46
    iget-object v7, v1, LI5;->R:Landroid/view/View$OnClickListener;

    invoke-virtual {v6, v7}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 47
    iget-object v6, v1, LI5;->p:Ljava/lang/CharSequence;
    ...
    iget-object v6, v1, LI5;->r:Landroid/graphics/drawable/Drawable;

    if-nez v6, :cond_c

    .line 48
    iget-object v6, v1, LI5;->o:Landroid/widget/Button;
    ...
    iget-object v7, v1, LI5;->p:Ljava/lang/CharSequence;
    ...
    iget-object v7, v1, LI5;->r:Landroid/graphics/drawable/Drawable;
    ...
    iput-object v7, v1, LI5;->s:Landroid/widget/Button;

    .line 55
    iget-object v8, v1, LI5;->R:Landroid/view/View$OnClickListener;

    invoke-virtual {v7, v8}, Landroid/widget/Button;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 56
    iget-object v7, v1, LI5;->t:Ljava/lang/CharSequence;
    ...
    iget-object v7, v1, LI5;->v:Landroid/graphics/drawable/Drawable;

    if-nez v7, :cond_e

    .line 57
    iget-object v7, v1, LI5;->s:Landroid/widget/Button;
    ...
    iput-object v7, v1, LI5;->w:Landroid/widget/Button;
    ...
    .line 65
    iget-object v7, v1, LI5;->x:Ljava/lang/CharSequence;
    ...
    iget-object v7, v1, LI5;->z:Landroid/graphics/drawable/Drawable;

    if-nez v7, :cond_10

    .line 66
    iget-object v7, v1, LI5;->w:Landroid/widget/Button;
    ...
    iget-object v8, v1, LI5;->x:Ljava/lang/CharSequence;
    ...
    iget-object v8, v1, LI5;->z:Landroid/graphics/drawable/Drawable;
    ...
    .line 72
    :goto_8
    iget-object v7, v1, LI5;->a:Landroid/content/Context;
    ...
    .line 76
    iget-object v7, v1, LI5;->o:Landroid/widget/Button;

    invoke-virtual {v1, v7}, LI5;->b(Landroid/widget/Button;)V
    ...
    .line 80
    :cond_17
    iget-object v6, v1, LI5;->G:Landroid/view/View;
    ...
    .line 82
    iget-object v10, v1, LI5;->G:Landroid/view/View;
    ...
    iput-object v6, v1, LI5;->D:Landroid/widget/ImageView;

    .line 86
    iget-object v6, v1, LI5;->e:Ljava/lang/CharSequence;
    ...
    iput-object v6, v1, LI5;->E:Landroid/widget/TextView;
    ...
    .line 91
    iget-object v7, v1, LI5;->D:Landroid/widget/ImageView;
    ...
    .line 92
    :cond_19
    iget-object v6, v1, LI5;->C:Landroid/graphics/drawable/Drawable;
    ...
    .line 94
    :cond_1a
    iget-object v6, v1, LI5;->E:Landroid/widget/TextView;
    ...
    iget-object v10, v1, LI5;->D:Landroid/widget/ImageView;
    ...
    iget-object v12, v1, LI5;->D:Landroid/widget/ImageView;
    ...
    iget-object v13, v1, LI5;->D:Landroid/widget/ImageView;
    ...
    .line 99
    iget-object v6, v1, LI5;->D:Landroid/widget/ImageView;
    ...
    .line 111
    :cond_20
    iget-object v6, v1, LI5;->f:Ljava/lang/CharSequence;
    ...
    :cond_24
    :goto_12
    iget-object v3, v1, LI5;->g:Landroid/widget/ListView;
    ...
    :cond_26
    iget v7, v3, Landroidx/appcompat/app/AlertController$RecycleListView;->y:I
    ...
    :cond_27
    iget v13, v3, Landroidx/appcompat/app/AlertController$RecycleListView;->z:I
    ...
    :cond_29
    iget-object v3, v1, LI5;->A:Landroidx/core/widget/NestedScrollView;
    ...
    .line 125
    iget-object v7, v1, LI5;->c:Landroid/view/Window;
    ...
    .line 133
    :cond_30
    iget-object v2, v1, LI5;->f:Ljava/lang/CharSequence;

    if-eqz v2, :cond_31

    .line 134
    iget-object v2, v1, LI5;->A:Landroidx/core/widget/NestedScrollView;

    new-instance v3, Ly5;

    invoke-direct {v3, v1, v6, v10}, Ly5;-><init>(LI5;Landroid/view/View;Landroid/view/View;)V

    .line 135
    iput-object v3, v2, Landroidx/core/widget/NestedScrollView;->a0:Ly5;

    .line 136
    new-instance v3, Lz5;

    invoke-direct {v3, v1, v6, v10}, Lz5;-><init>(LI5;Landroid/view/View;Landroid/view/View;)V
    ...
    .line 137
    :cond_31
    iget-object v2, v1, LI5;->g:Landroid/widget/ListView;
    ...
    invoke-direct {v3, v1, v6, v10}, LA5;-><init>(LI5;Landroid/view/View;Landroid/view/View;)V
    ...
    invoke-direct {v3, v1, v6, v10}, LB5;-><init>(LI5;Landroid/view/View;Landroid/view/View;)V
    ...
    .line 143
    iget-object v3, v1, LI5;->H:Landroid/widget/ListAdapter;
...
.method public setTitle(Ljava/lang/CharSequence;)V
    ...
    .line 1
    invoke-super {p0, p1}, Lma;->setTitle(Ljava/lang/CharSequence;)V
    ...
    .line 4
    iget-object v0, v0, LI5;->E:Landroid/widget/TextView;
