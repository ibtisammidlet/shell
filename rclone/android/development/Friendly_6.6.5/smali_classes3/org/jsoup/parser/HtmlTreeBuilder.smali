...
# instance fields
.field private e:Lorg/jsoup/parser/a;

.field private f:Lorg/jsoup/parser/a;

.field private g:Z

.field private h:Lorg/jsoup/nodes/Element;

.field private i:Lorg/jsoup/nodes/FormElement;

.field private j:Lorg/jsoup/nodes/Element;
...
.field private m:Lorg/jsoup/parser/Token$g;
...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->q:[Ljava/lang/String;
...
.method private C(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)Z
    ...
    iget-object v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->q:[Ljava/lang/String;

    const/4 v1, 0x0

    aput-object p1, v0, v1

    invoke-direct {p0, v0, p2, p3}, Lorg/jsoup/parser/HtmlTreeBuilder;->D([Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)Z
...
.method private N(Lorg/jsoup/nodes/Node;)V
    ...
    :cond_0
    invoke-virtual {p0}, Lorg/jsoup/parser/HtmlTreeBuilder;->R()Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-virtual {p0, p1}, Lorg/jsoup/parser/HtmlTreeBuilder;->L(Lorg/jsoup/nodes/Node;)V
    ...
    iget-object v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->i:Lorg/jsoup/nodes/FormElement;
...
.method private Q(Ljava/util/ArrayList;Lorg/jsoup/nodes/Element;)Z
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method private U(Lorg/jsoup/nodes/Element;Lorg/jsoup/nodes/Element;)Z
    .locals 2
...
.method private o0(Ljava/util/ArrayList;Lorg/jsoup/nodes/Element;Lorg/jsoup/nodes/Element;)V
    .locals 1
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
...
.method A([Ljava/lang/String;)Z
    ...
    sget-object v0, Lorg/jsoup/parser/HtmlTreeBuilder;->r:[Ljava/lang/String;

    const/4 v1, 0x0

    invoke-direct {p0, p1, v0, v1}, Lorg/jsoup/parser/HtmlTreeBuilder;->D([Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)Z
...
.method B(Ljava/lang/String;)Z
    ...
    :cond_0
    sget-object v4, Lorg/jsoup/parser/HtmlTreeBuilder;->v:[Ljava/lang/String;
...
.method E(Ljava/lang/String;)Z
    ...
    invoke-direct {p0, p1, v0, v1}, Lorg/jsoup/parser/HtmlTreeBuilder;->C(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)Z
...
.method F(Lorg/jsoup/parser/Token$h;)Lorg/jsoup/nodes/Element;
    .locals 4

    iget-object v0, p1, Lorg/jsoup/parser/Token$i;->j:Lorg/jsoup/nodes/Attributes;
    ...
    invoke-virtual {p0, v0}, Lorg/jsoup/parser/d;->error(Ljava/lang/String;)V
    ...
    invoke-virtual {p0, p1}, Lorg/jsoup/parser/HtmlTreeBuilder;->J(Lorg/jsoup/parser/Token$h;)Lorg/jsoup/nodes/Element;
    ...
    iget-object v1, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->m:Lorg/jsoup/parser/Token$g;
    ...
    invoke-virtual {v0, v1}, Lorg/jsoup/parser/b;->l(Lorg/jsoup/parser/Token;)V
    ...
    invoke-virtual {p0, v0}, Lorg/jsoup/parser/HtmlTreeBuilder;->G(Lorg/jsoup/nodes/Element;)V
...
.method G(Lorg/jsoup/nodes/Element;)V
    ...
    invoke-direct {p0, p1}, Lorg/jsoup/parser/HtmlTreeBuilder;->N(Lorg/jsoup/nodes/Node;)V
...
.method H(Lorg/jsoup/parser/Token$c;)V
    .locals 3
...
.method I(Lorg/jsoup/parser/Token$d;)V
    .locals 1
    ...
    invoke-direct {p0, v0}, Lorg/jsoup/parser/HtmlTreeBuilder;->N(Lorg/jsoup/nodes/Node;)V
...
.method J(Lorg/jsoup/parser/Token$h;)Lorg/jsoup/nodes/Element;
    ...
    iget-object v3, p1, Lorg/jsoup/parser/Token$i;->j:Lorg/jsoup/nodes/Attributes;
    ...
    invoke-direct {p0, v1}, Lorg/jsoup/parser/HtmlTreeBuilder;->N(Lorg/jsoup/nodes/Node;)V
    ...
    invoke-virtual {p1, v0}, Lorg/jsoup/parser/b;->r(Ljava/lang/String;)V
...
.method K(Lorg/jsoup/parser/Token$h;Z)Lorg/jsoup/nodes/FormElement;
    .locals 3
    ...
    invoke-virtual {p0, v1}, Lorg/jsoup/parser/HtmlTreeBuilder;->r0(Lorg/jsoup/nodes/FormElement;)V
...
.method L(Lorg/jsoup/nodes/Node;)V
    .locals 3

    const-string v0, "table"

    invoke-virtual {p0, v0}, Lorg/jsoup/parser/HtmlTreeBuilder;->s(Ljava/lang/String;)Lorg/jsoup/nodes/Element;
    ...
    :cond_0
    invoke-virtual {p0, v0}, Lorg/jsoup/parser/HtmlTreeBuilder;->d(Lorg/jsoup/nodes/Element;)Lorg/jsoup/nodes/Element;
...
.method M()V
    ...
    iget-object v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->k:Ljava/util/ArrayList;
...
.method O(Lorg/jsoup/nodes/Element;Lorg/jsoup/nodes/Element;)V
    .locals 2
...
.method P(Ljava/lang/String;)Lorg/jsoup/nodes/Element;
    .locals 2
...
.method R()Z
    ...
    iget-boolean v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->o:Z
...
.method T(Lorg/jsoup/nodes/Element;)Z
    .locals 1

    iget-object v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->k:Ljava/util/ArrayList;

    invoke-direct {p0, v0, p1}, Lorg/jsoup/parser/HtmlTreeBuilder;->Q(Ljava/util/ArrayList;Lorg/jsoup/nodes/Element;)Z
...
.method V(Lorg/jsoup/nodes/Element;)Z
    .locals 1
...
.method W()Lorg/jsoup/nodes/Element;
    .locals 2
...
.method X()V
    ...
    iget-object v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->e:Lorg/jsoup/parser/a;
...
.method Y(Lorg/jsoup/nodes/Element;)V
    .locals 1

    iget-boolean v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->g:Z
    ...
    iput-boolean v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->g:Z
...
.method Z()V
    ...
    iput-object v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->l:Ljava/util/List;
...
.method c(Ljava/lang/String;Lorg/jsoup/nodes/Element;Ljava/lang/String;Lorg/jsoup/parser/Parser;)Ljava/util/List;
    ...
    iput-object v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->e:Lorg/jsoup/parser/a;
    ...
    iput-object p2, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->j:Lorg/jsoup/nodes/Element;
    ...
    sget-object p4, Lorg/jsoup/parser/c;->c:Lorg/jsoup/parser/c;

    invoke-virtual {p1, p4}, Lorg/jsoup/parser/b;->v(Lorg/jsoup/parser/c;)V
    ...
    sget-object p4, Lorg/jsoup/parser/c;->e:Lorg/jsoup/parser/c;
    ...
    sget-object p4, Lorg/jsoup/parser/c;->f:Lorg/jsoup/parser/c;
    ...
    sget-object p4, Lorg/jsoup/parser/c;->a:Lorg/jsoup/parser/c;
    ...
    iget-object p4, p0, Lorg/jsoup/parser/d;->settings:Lorg/jsoup/parser/ParseSettings;
    ...
    invoke-virtual {p0}, Lorg/jsoup/parser/HtmlTreeBuilder;->q0()V
    ...
    iput-object p4, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->i:Lorg/jsoup/nodes/FormElement;
...
.method d(Lorg/jsoup/nodes/Element;)Lorg/jsoup/nodes/Element;
    .locals 2
...
.method e()V
    ...
    invoke-virtual {p0}, Lorg/jsoup/parser/HtmlTreeBuilder;->m0()Lorg/jsoup/nodes/Element;
...
.method e0(Ljava/lang/String;)Lorg/jsoup/nodes/Element;
    .locals 3
...
.method varargs f0([Ljava/lang/String;)V
    .locals 3
...
.method g()V
    ...
    invoke-direct {p0, v0}, Lorg/jsoup/parser/HtmlTreeBuilder;->f([Ljava/lang/String;)V

    return-void
.end method

.method g0(Lorg/jsoup/parser/Token;Lorg/jsoup/parser/a;)Z
    .locals 0

    iput-object p1, p0, Lorg/jsoup/parser/d;->currentToken:Lorg/jsoup/parser/Token;

    invoke-virtual {p2, p1, p0}, Lorg/jsoup/parser/a;->j(Lorg/jsoup/parser/Token;Lorg/jsoup/parser/HtmlTreeBuilder;)Z
...
.method h0(Lorg/jsoup/nodes/Element;)V
    .locals 1
...
.method i0(Lorg/jsoup/nodes/Element;)V
    .locals 3
    ...
    iget-object v2, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->k:Ljava/util/ArrayList;
    ...
    :cond_0
    invoke-direct {p0, p1, v2}, Lorg/jsoup/parser/HtmlTreeBuilder;->U(Lorg/jsoup/nodes/Element;Lorg/jsoup/nodes/Element;)Z
    ...
    iget-object v1, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->k:Ljava/util/ArrayList;
...
.method protected initialiseParse(Ljava/io/Reader;Ljava/lang/String;Lorg/jsoup/parser/Parser;)V
    ...
    sget-object p1, Lorg/jsoup/parser/a;->a:Lorg/jsoup/parser/a;

    iput-object p1, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->e:Lorg/jsoup/parser/a;
    ...
    iput-boolean p2, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->g:Z

    iput-object p1, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->h:Lorg/jsoup/nodes/Element;

    iput-object p1, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->i:Lorg/jsoup/nodes/FormElement;

    iput-object p1, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->j:Lorg/jsoup/nodes/Element;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->k:Ljava/util/ArrayList;

    new-instance p1, Ljava/util/ArrayList;

    invoke-direct {p1}, Ljava/util/ArrayList;-><init>()V

    iput-object p1, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->l:Ljava/util/List;

    new-instance p1, Lorg/jsoup/parser/Token$g;

    invoke-direct {p1}, Lorg/jsoup/parser/Token$g;-><init>()V

    iput-object p1, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->m:Lorg/jsoup/parser/Token$g;

    const/4 p1, 0x1

    iput-boolean p1, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->n:Z

    iput-boolean p2, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->o:Z
...
.method j(Lorg/jsoup/parser/a;)V
    .locals 6
    ...
    iget-object v5, p0, Lorg/jsoup/parser/d;->currentToken:Lorg/jsoup/parser/Token;
...
.method j0()V
    ...
    invoke-virtual {p0}, Lorg/jsoup/parser/HtmlTreeBuilder;->W()Lorg/jsoup/nodes/Element;

    move-result-object v0

    if-eqz v0, :cond_5

    invoke-virtual {p0, v0}, Lorg/jsoup/parser/HtmlTreeBuilder;->a0(Lorg/jsoup/nodes/Element;)Z
    ...
    invoke-virtual {p0, v2}, Lorg/jsoup/parser/HtmlTreeBuilder;->P(Ljava/lang/String;)Lorg/jsoup/nodes/Element;
    ...
    iget-object v5, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->k:Ljava/util/ArrayList;
...
.method k0(Lorg/jsoup/nodes/Element;)V
    .locals 2
    ...
    iget-object p1, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->k:Ljava/util/ArrayList;
...
.method l()Z
    ...
    iget-boolean v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->n:Z

    return v0
.end method

.method l0(Lorg/jsoup/nodes/Element;)Z
    .locals 3
...
.method m()V
    ...
    invoke-virtual {p0, v0}, Lorg/jsoup/parser/HtmlTreeBuilder;->n(Ljava/lang/String;)V

    return-void
.end method

.method m0()Lorg/jsoup/nodes/Element;
    .locals 2
...
.method n0(Lorg/jsoup/nodes/Element;Lorg/jsoup/nodes/Element;)V
    .locals 1

    iget-object v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->k:Ljava/util/ArrayList;

    invoke-direct {p0, v0, p1, p2}, Lorg/jsoup/parser/HtmlTreeBuilder;->o0(Ljava/util/ArrayList;Lorg/jsoup/nodes/Element;Lorg/jsoup/nodes/Element;)V

    return-void
.end method

.method o(Ljava/lang/String;)Lorg/jsoup/nodes/Element;
    .locals 3
...
.method p0(Lorg/jsoup/nodes/Element;Lorg/jsoup/nodes/Element;)V
    .locals 1
...
.method protected process(Lorg/jsoup/parser/Token;)Z
    ...
    invoke-virtual {v0, p1, p0}, Lorg/jsoup/parser/a;->j(Lorg/jsoup/parser/Token;Lorg/jsoup/parser/HtmlTreeBuilder;)Z
...
.method q()Lorg/jsoup/nodes/Document;
    .locals 1
...
.method q0()V
    ...
    iget-object v3, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->j:Lorg/jsoup/nodes/Element;
    ...
    invoke-virtual {p0, v0}, Lorg/jsoup/parser/HtmlTreeBuilder;->v0(Lorg/jsoup/parser/a;)V
...
.method r()Lorg/jsoup/nodes/FormElement;
    .locals 1
...
.method r0(Lorg/jsoup/nodes/FormElement;)V
    .locals 0
...
.method s(Ljava/lang/String;)Lorg/jsoup/nodes/Element;
    .locals 3
...
.method s0(Z)V
    ...
    iput-boolean p1, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->o:Z
...
.method t()Lorg/jsoup/nodes/Element;
    ...
    iget-object v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->h:Lorg/jsoup/nodes/Element;

    return-object v0
.end method

.method t0(Lorg/jsoup/nodes/Element;)V
    .locals 0
...
.method public toString()Ljava/lang/String;
    ...
    iget-object v1, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->e:Lorg/jsoup/parser/a;
...
.method u()Ljava/util/List;
    ...
    iget-object v0, p0, Lorg/jsoup/parser/HtmlTreeBuilder;->l:Ljava/util/List;

    return-object v0
.end method

.method u0()Lorg/jsoup/parser/a;
    .locals 1
...
.method v0(Lorg/jsoup/parser/a;)V
    .locals 0
...
.method w(Ljava/lang/String;)Z
    ...
    invoke-virtual {p0, p1, v0}, Lorg/jsoup/parser/HtmlTreeBuilder;->z(Ljava/lang/String;[Ljava/lang/String;)Z
...
.method z(Ljava/lang/String;[Ljava/lang/String;)Z
    .locals 1

    sget-object v0, Lorg/jsoup/parser/HtmlTreeBuilder;->r:[Ljava/lang/String;

    invoke-direct {p0, p1, v0, p2}, Lorg/jsoup/parser/HtmlTreeBuilder;->C(Ljava/lang/String;[Ljava/lang/String;[Ljava/lang/String;)Z
