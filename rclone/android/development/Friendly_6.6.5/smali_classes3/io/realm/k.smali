...
.method private j(Ljava/lang/String;[Lio/realm/FieldAttribute;)V
    .locals 3
    ...
    invoke-static {p2, v1}, Lio/realm/k;->o([Lio/realm/FieldAttribute;Lio/realm/FieldAttribute;)Z

    move-result v1

    if-eqz v1, :cond_0

    invoke-virtual {p0, p1}, Lio/realm/k;->addIndex(Ljava/lang/String;)Lio/realm/RealmObjectSchema;
    ...
    invoke-virtual {p0, p1}, Lio/realm/k;->addPrimaryKey(Ljava/lang/String;)Lio/realm/RealmObjectSchema;
    :try_end_0
...
.method private n(Ljava/lang/String;)V
    ...
    invoke-direct {p0, p1}, Lio/realm/k;->m(Ljava/lang/String;)V

    return-void
.end method

.method static o([Lio/realm/FieldAttribute;Lio/realm/FieldAttribute;)Z
    .locals 4
...
.method public varargs addField(Ljava/lang/String;Ljava/lang/Class;[Lio/realm/FieldAttribute;)Lio/realm/RealmObjectSchema;
    ...
    invoke-static {p3, p2}, Lio/realm/k;->o([Lio/realm/FieldAttribute;Lio/realm/FieldAttribute;)Z
    ...
    :cond_3
    invoke-direct {p0, p1}, Lio/realm/k;->n(Ljava/lang/String;)V

    iget-boolean p2, v0, Lio/realm/RealmObjectSchema$b;->c:Z

    sget-object v2, Lio/realm/FieldAttribute;->REQUIRED:Lio/realm/FieldAttribute;

    invoke-static {p3, v2}, Lio/realm/k;->o([Lio/realm/FieldAttribute;Lio/realm/FieldAttribute;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p3}, Lio/realm/k;->j(Ljava/lang/String;[Lio/realm/FieldAttribute;)V
    :try_end_0
    .catch Ljava/lang/Exception; {:try_start_0 .. :try_end_0} :catch_0
...
.method varargs e(Ljava/lang/String;[Lio/realm/RealmFieldType;)Lio/realm/internal/fields/FieldDescriptor;
    .locals 2

    invoke-virtual {p0}, Lio/realm/RealmObjectSchema;->getSchemaConnector()Lio/realm/q;

    move-result-object v0

    invoke-virtual {p0}, Lio/realm/RealmObjectSchema;->h()Lio/realm/internal/Table;
...
.method public renameField(Ljava/lang/String;Ljava/lang/String;)Lio/realm/RealmObjectSchema;
    ...
    invoke-direct {p0, p2}, Lio/realm/k;->m(Ljava/lang/String;)V
...
.method public setClassName(Ljava/lang/String;)Lio/realm/RealmObjectSchema;
    ...
    invoke-direct {p0, p1}, Lio/realm/k;->l(Ljava/lang/String;)V
...
.method public setNullable(Ljava/lang/String;Z)Lio/realm/RealmObjectSchema;
    ...
    invoke-virtual {p0, p1, p2}, Lio/realm/k;->setRequired(Ljava/lang/String;Z)Lio/realm/RealmObjectSchema;
