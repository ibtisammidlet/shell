...
.method static f(JLjava/util/Locale;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/material/datepicker/j;->c(Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    :cond_0
    invoke-static {p2}, Lcom/google/android/material/datepicker/j;->j(Ljava/util/Locale;)Ljava/text/DateFormat;
...
.method static h(JLjava/util/Locale;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/material/datepicker/j;->d(Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    :cond_0
    invoke-static {p2}, Lcom/google/android/material/datepicker/j;->h(Ljava/util/Locale;)Ljava/text/DateFormat;
...
.method static k(JLjava/util/Locale;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/material/datepicker/j;->s(Ljava/util/Locale;)Landroid/icu/text/DateFormat;
    ...
    :cond_0
    invoke-static {p2}, Lcom/google/android/material/datepicker/j;->i(Ljava/util/Locale;)Ljava/text/DateFormat;
...
.method static m(JLjava/util/Locale;)Ljava/lang/String;
    ...
    invoke-static {p2}, Lcom/google/android/material/datepicker/j;->t(Ljava/util/Locale;)Landroid/icu/text/DateFormat;
