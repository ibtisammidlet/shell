...
.method static k(Landroid/view/View;)Landroid/graphics/Rect;
    .locals 4
...
.method private static m(Lcom/google/android/material/shape/ShapeAppearanceModel;Landroid/graphics/RectF;)Z
    .locals 2
...
.method static p(FFFFFZ)F
    ...
    :cond_0
    invoke-static {p0, p1, p4}, Lcom/google/android/material/transition/platform/j;->n(FFF)F
...
.method static r(Lcom/google/android/material/shape/ShapeAppearanceModel;Lcom/google/android/material/shape/ShapeAppearanceModel;Landroid/graphics/RectF;Landroid/graphics/RectF;FFF)Lcom/google/android/material/shape/ShapeAppearanceModel;
    .locals 7
    .param p4    # F
        .annotation build Landroidx/annotation/FloatRange;
            from = 0.0
...
.method static t(Landroid/transition/Transition;Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Z
    ...
    invoke-static {p1, p2, p3}, Lcom/google/android/material/transition/platform/j;->v(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;
...
.method static u(Landroid/transition/Transition;Landroid/content/Context;I)Z
    ...
    invoke-static {p1, p2}, Lcom/google/android/material/transition/platform/j;->w(Landroid/content/Context;I)Landroid/transition/PathMotion;
...
.method static v(Landroid/content/Context;ILandroid/animation/TimeInterpolator;)Landroid/animation/TimeInterpolator;
    .locals 2
    .param p1    # I
        .annotation build Landroidx/annotation/AttrRes;
        .end annotation
    ...
    invoke-static {p0, p2}, Lcom/google/android/material/transition/platform/j;->l(Ljava/lang/String;Ljava/lang/String;)Z

    move-result v0

    if-eqz v0, :cond_1

    invoke-static {p0, p2}, Lcom/google/android/material/transition/platform/j;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
    ...
    invoke-static {p0, p2}, Lcom/google/android/material/transition/platform/j;->g([Ljava/lang/String;I)F

    move-result p2

    invoke-static {p0, v1}, Lcom/google/android/material/transition/platform/j;->g([Ljava/lang/String;I)F
    ...
    invoke-static {p0, p1}, Lcom/google/android/material/transition/platform/j;->g([Ljava/lang/String;I)F
    ...
    invoke-static {p0, p1}, Lcom/google/android/material/transition/platform/j;->l(Ljava/lang/String;Ljava/lang/String;)Z

    move-result p2

    if-eqz p2, :cond_2

    invoke-static {p0, p1}, Lcom/google/android/material/transition/platform/j;->h(Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method static y(Landroid/graphics/Canvas;Landroid/graphics/Rect;FFFILcom/google/android/material/transition/platform/j$c;)V
    .locals 1
    ...
    invoke-static {p0, p1, p5}, Lcom/google/android/material/transition/platform/j;->x(Landroid/graphics/Canvas;Landroid/graphics/Rect;I)I
...
.method static z(Lcom/google/android/material/shape/ShapeAppearanceModel;Lcom/google/android/material/shape/ShapeAppearanceModel;Landroid/graphics/RectF;Lcom/google/android/material/transition/platform/j$d;)Lcom/google/android/material/shape/ShapeAppearanceModel;
    .locals 2

    invoke-static {p0, p2}, Lcom/google/android/material/transition/platform/j;->m(Lcom/google/android/material/shape/ShapeAppearanceModel;Landroid/graphics/RectF;)Z
