...
.method private b(Ljava/lang/Object;)V
    ...
    :try_start_0
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/r;->a:Lcom/bumptech/glide/load/engine/f;

    invoke-virtual {v3, p1}, Lcom/bumptech/glide/load/engine/f;->p(Ljava/lang/Object;)Lcom/bumptech/glide/load/Encoder;

    move-result-object v3

    new-instance v4, Lcom/bumptech/glide/load/engine/e;

    iget-object v5, p0, Lcom/bumptech/glide/load/engine/r;->a:Lcom/bumptech/glide/load/engine/f;

    invoke-virtual {v5}, Lcom/bumptech/glide/load/engine/f;->k()Lcom/bumptech/glide/load/Options;

    move-result-object v5

    invoke-direct {v4, v3, p1, v5}, Lcom/bumptech/glide/load/engine/e;-><init>(Lcom/bumptech/glide/load/Encoder;Ljava/lang/Object;Lcom/bumptech/glide/load/Options;)V

    new-instance v5, Lcom/bumptech/glide/load/engine/d;

    iget-object v6, p0, Lcom/bumptech/glide/load/engine/r;->f:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;

    iget-object v6, v6, Lcom/bumptech/glide/load/model/ModelLoader$LoadData;->sourceKey:Lcom/bumptech/glide/load/Key;

    iget-object v7, p0, Lcom/bumptech/glide/load/engine/r;->a:Lcom/bumptech/glide/load/engine/f;

    invoke-virtual {v7}, Lcom/bumptech/glide/load/engine/f;->o()Lcom/bumptech/glide/load/Key;

    move-result-object v7

    invoke-direct {v5, v6, v7}, Lcom/bumptech/glide/load/engine/d;-><init>(Lcom/bumptech/glide/load/Key;Lcom/bumptech/glide/load/Key;)V

    iput-object v5, p0, Lcom/bumptech/glide/load/engine/r;->g:Lcom/bumptech/glide/load/engine/d;

    iget-object v5, p0, Lcom/bumptech/glide/load/engine/r;->a:Lcom/bumptech/glide/load/engine/f;

    invoke-virtual {v5}, Lcom/bumptech/glide/load/engine/f;->d()Lcom/bumptech/glide/load/engine/cache/DiskCache;

    move-result-object v5

    iget-object v6, p0, Lcom/bumptech/glide/load/engine/r;->g:Lcom/bumptech/glide/load/engine/d;
    ...
    iget-object v5, p0, Lcom/bumptech/glide/load/engine/r;->g:Lcom/bumptech/glide/load/engine/d;
    ...
    :cond_0
    iget-object p1, p0, Lcom/bumptech/glide/load/engine/r;->f:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/r;->f:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
...
.method public a()Z
    ...
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/r;->e:Ljava/lang/Object;

    const/4 v1, 0x0

    if-eqz v0, :cond_0

    iput-object v1, p0, Lcom/bumptech/glide/load/engine/r;->e:Ljava/lang/Object;

    invoke-direct {p0, v0}, Lcom/bumptech/glide/load/engine/r;->b(Ljava/lang/Object;)V
    ...
    iput-object v1, p0, Lcom/bumptech/glide/load/engine/r;->f:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/r;->f:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
    ...
    iget-object v3, p0, Lcom/bumptech/glide/load/engine/r;->f:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
...
.method e(Lcom/bumptech/glide/load/model/ModelLoader$LoadData;Ljava/lang/Object;)V
    ...
    iput-object p2, p0, Lcom/bumptech/glide/load/engine/r;->e:Ljava/lang/Object;
...
.method f(Lcom/bumptech/glide/load/model/ModelLoader$LoadData;Ljava/lang/Exception;)V
    ...
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/r;->g:Lcom/bumptech/glide/load/engine/d;
...
.method public onDataFetcherReady(Lcom/bumptech/glide/load/Key;Ljava/lang/Object;Lcom/bumptech/glide/load/data/DataFetcher;Lcom/bumptech/glide/load/DataSource;Lcom/bumptech/glide/load/Key;)V
    ...
    iget-object p4, p0, Lcom/bumptech/glide/load/engine/r;->f:Lcom/bumptech/glide/load/model/ModelLoader$LoadData;
