...
# instance fields
.field private final a:Lcom/fasterxml/jackson/databind/introspect/ClassIntrospector$MixInResolver;
...
.method constructor <init>(Lcom/fasterxml/jackson/databind/AnnotationIntrospector;Lcom/fasterxml/jackson/databind/introspect/ClassIntrospector$MixInResolver;Z)V
    ...
    iput-boolean p3, p0, Lcom/fasterxml/jackson/databind/introspect/AnnotatedMethodCollector;->b:Z

    return-void
.end method

.method private c(Lcom/fasterxml/jackson/databind/introspect/TypeResolutionContext;Ljava/lang/Class;Ljava/util/Map;Ljava/lang/Class;)V
    .locals 5
    ...
    invoke-static {v1}, Lcom/fasterxml/jackson/databind/introspect/AnnotatedMethodCollector;->d(Ljava/lang/reflect/Method;)Z
    ...
    iget-object v3, p0, Lcom/fasterxml/jackson/databind/introspect/b;->_intr:Lcom/fasterxml/jackson/databind/AnnotationIntrospector;
    ...
    invoke-virtual {p0, v3}, Lcom/fasterxml/jackson/databind/introspect/b;->collectAnnotations([Ljava/lang/annotation/Annotation;)Lcom/fasterxml/jackson/databind/introspect/AnnotationCollector;
    ...
    :cond_4
    iget-boolean v2, p0, Lcom/fasterxml/jackson/databind/introspect/AnnotatedMethodCollector;->b:Z
    ...
    invoke-virtual {p0, v2, v4}, Lcom/fasterxml/jackson/databind/introspect/b;->collectDefaultAnnotations(Lcom/fasterxml/jackson/databind/introspect/AnnotationCollector;[Ljava/lang/annotation/Annotation;)Lcom/fasterxml/jackson/databind/introspect/AnnotationCollector;
...
.method protected _addMethodMixIns(Lcom/fasterxml/jackson/databind/introspect/TypeResolutionContext;Ljava/lang/Class;Ljava/util/Map;Ljava/lang/Class;)V
    ...
    iget-object v0, p0, Lcom/fasterxml/jackson/databind/introspect/b;->_intr:Lcom/fasterxml/jackson/databind/AnnotationIntrospector;
    ...
    invoke-static {v2}, Lcom/fasterxml/jackson/databind/introspect/AnnotatedMethodCollector;->d(Ljava/lang/reflect/Method;)Z
    ...
    invoke-virtual {p0, v2}, Lcom/fasterxml/jackson/databind/introspect/b;->collectAnnotations([Ljava/lang/annotation/Annotation;)Lcom/fasterxml/jackson/databind/introspect/AnnotationCollector;
    ...
    invoke-virtual {p0, v3, v2}, Lcom/fasterxml/jackson/databind/introspect/b;->collectDefaultAnnotations(Lcom/fasterxml/jackson/databind/introspect/AnnotationCollector;[Ljava/lang/annotation/Annotation;)Lcom/fasterxml/jackson/databind/introspect/AnnotationCollector;
...
.method e(Lcom/fasterxml/jackson/databind/type/TypeFactory;Lcom/fasterxml/jackson/databind/introspect/TypeResolutionContext;Lcom/fasterxml/jackson/databind/JavaType;Ljava/util/List;Ljava/lang/Class;)Lcom/fasterxml/jackson/databind/introspect/AnnotatedMethodMap;
    .locals 5
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    invoke-direct {p0, p2, v2, v1, p5}, Lcom/fasterxml/jackson/databind/introspect/AnnotatedMethodCollector;->c(Lcom/fasterxml/jackson/databind/introspect/TypeResolutionContext;Ljava/lang/Class;Ljava/util/Map;Ljava/lang/Class;)V
    ...
    iget-object v2, p0, Lcom/fasterxml/jackson/databind/introspect/AnnotatedMethodCollector;->a:Lcom/fasterxml/jackson/databind/introspect/ClassIntrospector$MixInResolver;
    ...
    invoke-direct {p0, v3, p5, v1, v2}, Lcom/fasterxml/jackson/databind/introspect/AnnotatedMethodCollector;->c(Lcom/fasterxml/jackson/databind/introspect/TypeResolutionContext;Ljava/lang/Class;Ljava/util/Map;Ljava/lang/Class;)V

    goto :goto_0

    :cond_1
    iget-object p1, p0, Lcom/fasterxml/jackson/databind/introspect/AnnotatedMethodCollector;->a:Lcom/fasterxml/jackson/databind/introspect/ClassIntrospector$MixInResolver;
    ...
    iget-object p1, p0, Lcom/fasterxml/jackson/databind/introspect/b;->_intr:Lcom/fasterxml/jackson/databind/AnnotationIntrospector;
    ...
    iget-object p5, p2, Lcom/fasterxml/jackson/databind/introspect/AnnotatedMethodCollector$a;->c:Lcom/fasterxml/jackson/databind/introspect/AnnotationCollector;

    invoke-virtual {p3}, Ljava/lang/reflect/Method;->getDeclaredAnnotations()[Ljava/lang/annotation/Annotation;

    move-result-object v2

    invoke-virtual {p0, p5, v2}, Lcom/fasterxml/jackson/databind/introspect/b;->collectDefaultAnnotations(Lcom/fasterxml/jackson/databind/introspect/AnnotationCollector;[Ljava/lang/annotation/Annotation;)Lcom/fasterxml/jackson/databind/introspect/AnnotationCollector;

    move-result-object p5

    iput-object p5, p2, Lcom/fasterxml/jackson/databind/introspect/AnnotatedMethodCollector$a;->c:Lcom/fasterxml/jackson/databind/introspect/AnnotationCollector;
