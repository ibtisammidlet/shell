.class final Landroidx/multidex/a;
...
.method constructor <init>(Ljava/io/File;Ljava/io/File;)V
    ...
    iput-object p1, p0, Landroidx/multidex/a;->a:Ljava/io/File;

    iput-object p2, p0, Landroidx/multidex/a;->c:Ljava/io/File;

    invoke-static {p1}, Landroidx/multidex/a;->f(Ljava/io/File;)J

    move-result-wide v2

    iput-wide v2, p0, Landroidx/multidex/a;->b:J
    ...
    iput-object p2, p0, Landroidx/multidex/a;->d:Ljava/io/RandomAccessFile;
    ...
    iput-object p2, p0, Landroidx/multidex/a;->e:Ljava/nio/channels/FileChannel;
    :try_end_0
    ...
    iput-object p2, p0, Landroidx/multidex/a;->f:Ljava/nio/channels/FileLock;
    :try_end_1
    ...
    :goto_0
    iget-object p2, p0, Landroidx/multidex/a;->e:Ljava/nio/channels/FileChannel;

    invoke-static {p2}, Landroidx/multidex/a;->b(Ljava/io/Closeable;)V
    ...
    :goto_1
    iget-object p2, p0, Landroidx/multidex/a;->d:Ljava/io/RandomAccessFile;
...
.method private a()V
    ...
    iget-object v0, p0, Landroidx/multidex/a;->c:Ljava/io/File;

    new-instance v1, Landroidx/multidex/a$a;

    invoke-direct {v1, p0}, Landroidx/multidex/a$a;-><init>(Landroidx/multidex/a;)V
    ...
    iget-object v2, p0, Landroidx/multidex/a;->c:Ljava/io/File;
...
.method private static c(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {p0}, Landroidx/multidex/a;->b(Ljava/io/Closeable;)V
...
.method private static g(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    invoke-static {p0}, Landroidx/multidex/a;->d(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    invoke-static {p1}, Landroidx/multidex/a;->e(Ljava/io/File;)J
...
.method private i(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    iget-object v3, v0, Landroidx/multidex/a;->a:Ljava/io/File;
    ...
    invoke-static/range {p1 .. p1}, Landroidx/multidex/a;->d(Landroid/content/Context;)Landroid/content/SharedPreferences;
    ...
    new-instance v8, Landroidx/multidex/a$b;

    iget-object v9, v0, Landroidx/multidex/a;->c:Ljava/io/File;

    invoke-direct {v8, v9, v7}, Landroidx/multidex/a$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8}, Landroidx/multidex/a;->f(Ljava/io/File;)J

    move-result-wide v9

    iput-wide v9, v8, Landroidx/multidex/a$b;->a:J
    ...
    iget-wide v2, v8, Landroidx/multidex/a$b;->a:J
    ...
    iget-wide v4, v8, Landroidx/multidex/a$b;->a:J
...
.method private j()Ljava/util/List;
    ...
    iget-object v6, v1, Landroidx/multidex/a;->a:Ljava/io/File;
    ...
    invoke-direct/range {p0 .. p0}, Landroidx/multidex/a;->a()V
    ...
    iget-object v0, v1, Landroidx/multidex/a;->a:Ljava/io/File;
    ...
    new-instance v11, Landroidx/multidex/a$b;

    iget-object v12, v1, Landroidx/multidex/a;->c:Ljava/io/File;

    invoke-direct {v11, v12, v0}, Landroidx/multidex/a$b;-><init>(Ljava/io/File;Ljava/lang/String;)V
    ...
    invoke-static {v8, v10, v11, v6}, Landroidx/multidex/a;->c(Ljava/util/zip/ZipFile;Ljava/util/zip/ZipEntry;Ljava/io/File;Ljava/lang/String;)V
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0

    :try_start_1
    invoke-static {v11}, Landroidx/multidex/a;->f(Ljava/io/File;)J

    move-result-wide v14

    iput-wide v14, v11, Landroidx/multidex/a$b;->a:J
    :try_end_1
    ...
    iget-wide v12, v11, Landroidx/multidex/a$b;->a:J
...
.method private static k(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
    ...
    check-cast p4, Landroidx/multidex/a$b;
    ...
    iget-wide v0, p4, Landroidx/multidex/a$b;->a:J
...
.method public close()V
    ...
    iget-object v0, p0, Landroidx/multidex/a;->f:Ljava/nio/channels/FileLock;

    invoke-virtual {v0}, Ljava/nio/channels/FileLock;->release()V

    iget-object v0, p0, Landroidx/multidex/a;->e:Ljava/nio/channels/FileChannel;

    invoke-virtual {v0}, Ljava/nio/channels/FileChannel;->close()V

    iget-object v0, p0, Landroidx/multidex/a;->d:Ljava/io/RandomAccessFile;
...
.method h(Landroid/content/Context;Ljava/lang/String;Z)Ljava/util/List;
    ...
    iget-object v1, p0, Landroidx/multidex/a;->a:Ljava/io/File;
    ...
    iget-object v0, p0, Landroidx/multidex/a;->a:Ljava/io/File;

    iget-wide v2, p0, Landroidx/multidex/a;->b:J

    invoke-static {p1, v0, v2, v3, p2}, Landroidx/multidex/a;->g(Landroid/content/Context;Ljava/io/File;JLjava/lang/String;)Z
    ...
    :try_start_0
    invoke-direct {p0, p1, p2}, Landroidx/multidex/a;->i(Landroid/content/Context;Ljava/lang/String;)Ljava/util/List;
    ...
    invoke-direct {p0}, Landroidx/multidex/a;->j()Ljava/util/List;

    move-result-object p3

    iget-object v0, p0, Landroidx/multidex/a;->a:Ljava/io/File;

    invoke-static {v0}, Landroidx/multidex/a;->e(Ljava/io/File;)J

    move-result-wide v4

    iget-wide v6, p0, Landroidx/multidex/a;->b:J
    ...
    invoke-static/range {v2 .. v8}, Landroidx/multidex/a;->k(Landroid/content/Context;Ljava/lang/String;JJLjava/util/List;)V
