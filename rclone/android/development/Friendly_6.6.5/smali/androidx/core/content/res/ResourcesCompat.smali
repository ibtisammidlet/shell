...
.method private static a(Landroidx/core/content/res/ResourcesCompat$b;ILandroid/content/res/ColorStateList;)V
    .locals 3
    .param p0    # Landroidx/core/content/res/ResourcesCompat$b;
    ...
    :cond_0
    new-instance v1, Landroidx/core/content/res/ResourcesCompat$a;

    iget-object p0, p0, Landroidx/core/content/res/ResourcesCompat$b;->a:Landroid/content/res/Resources;

    invoke-virtual {p0}, Landroid/content/res/Resources;->getConfiguration()Landroid/content/res/Configuration;

    move-result-object p0

    invoke-direct {v1, p2, p0}, Landroidx/core/content/res/ResourcesCompat$a;-><init>(Landroid/content/res/ColorStateList;Landroid/content/res/Configuration;)V
...
.method private static b(Landroidx/core/content/res/ResourcesCompat$b;I)Landroid/content/res/ColorStateList;
    .locals 4
    .param p0    # Landroidx/core/content/res/ResourcesCompat$b;
        .annotation build Landroidx/annotation/NonNull;
        .end annotation
    ...
    check-cast v2, Landroidx/core/content/res/ResourcesCompat$a;

    if-eqz v2, :cond_1

    iget-object v3, v2, Landroidx/core/content/res/ResourcesCompat$a;->b:Landroid/content/res/Configuration;
    ...
    iget-object p0, v2, Landroidx/core/content/res/ResourcesCompat$a;->a:Landroid/content/res/ColorStateList;
...
.method public static getColorStateList(Landroid/content/res/Resources;ILandroid/content/res/Resources$Theme;)Landroid/content/res/ColorStateList;
    ...
    :cond_0
    new-instance v0, Landroidx/core/content/res/ResourcesCompat$b;

    invoke-direct {v0, p0, p2}, Landroidx/core/content/res/ResourcesCompat$b;-><init>(Landroid/content/res/Resources;Landroid/content/res/Resources$Theme;)V

    invoke-static {v0, p1}, Landroidx/core/content/res/ResourcesCompat;->b(Landroidx/core/content/res/ResourcesCompat$b;I)Landroid/content/res/ColorStateList;
    ...
    invoke-static {v0, p1, p2}, Landroidx/core/content/res/ResourcesCompat;->a(Landroidx/core/content/res/ResourcesCompat$b;ILandroid/content/res/ColorStateList;)V
