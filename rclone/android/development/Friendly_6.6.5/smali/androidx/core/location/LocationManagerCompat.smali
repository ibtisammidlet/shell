...
.method static constructor <clinit>()V
    ...
    sput-object v0, Landroidx/core/location/LocationManagerCompat;->b:Landroidx/collection/SimpleArrayMap;
...
.method private static a(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
    ...
    sget-object v3, Landroidx/core/location/LocationManagerCompat;->b:Landroidx/collection/SimpleArrayMap;
    ...
    check-cast p1, Landroidx/core/location/LocationManagerCompat$g;

    if-nez p1, :cond_0

    new-instance p1, Landroidx/core/location/LocationManagerCompat$g;

    invoke-direct {p1, p3}, Landroidx/core/location/LocationManagerCompat$g;-><init>(Landroidx/core/location/GnssStatusCompat$Callback;)V
    ...
    sget-object v0, Landroidx/core/location/LocationManagerCompat;->b:Landroidx/collection/SimpleArrayMap;
    ...
    invoke-direct {v3, p3}, Landroidx/core/location/LocationManagerCompat$j;-><init>(Landroidx/core/location/GnssStatusCompat$Callback;)V

    goto :goto_1

    :cond_4
    invoke-virtual {v3}, Landroidx/core/location/LocationManagerCompat$j;->b()V

    :goto_1
    invoke-virtual {v3, p2}, Landroidx/core/location/LocationManagerCompat$j;->a(Ljava/util/concurrent/Executor;)V
    ...
    check-cast v3, Landroidx/core/location/LocationManagerCompat$h;

    if-nez v3, :cond_8

    new-instance v3, Landroidx/core/location/LocationManagerCompat$h;

    invoke-direct {v3, p0, p3}, Landroidx/core/location/LocationManagerCompat$h;-><init>(Landroid/location/LocationManager;Landroidx/core/location/GnssStatusCompat$Callback;)V

    goto :goto_3

    :cond_8
    invoke-virtual {v3}, Landroidx/core/location/LocationManagerCompat$h;->b()V

    :goto_3
    invoke-virtual {v3, p2}, Landroidx/core/location/LocationManagerCompat$h;->a(Ljava/util/concurrent/Executor;)V

    new-instance p2, Ljava/util/concurrent/FutureTask;

    new-instance v4, Landroidx/core/location/LocationManagerCompat$c;

    invoke-direct {v4, p0, v3}, Landroidx/core/location/LocationManagerCompat$c;-><init>(Landroid/location/LocationManager;Landroidx/core/location/LocationManagerCompat$h;)V
    ...
    sget-object v4, Landroidx/core/location/LocationManagerCompat;->b:Landroidx/collection/SimpleArrayMap;
...
.method public static getCurrentLocation(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/os/CancellationSignal;Ljava/util/concurrent/Executor;Landroidx/core/util/Consumer;)V
    ...
    invoke-static {p0, p1, p2, p3, p4}, Landroidx/core/location/LocationManagerCompat$e;->a(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/os/CancellationSignal;Ljava/util/concurrent/Executor;Landroidx/core/util/Consumer;)V
    ...
    new-instance p0, Landroidx/core/location/LocationManagerCompat$a;

    invoke-direct {p0, p4, v0}, Landroidx/core/location/LocationManagerCompat$a;-><init>(Landroidx/core/util/Consumer;Landroid/location/Location;)V
    ...
    new-instance p0, Landroidx/core/location/LocationManagerCompat$b;

    invoke-direct {p0, v0}, Landroidx/core/location/LocationManagerCompat$b;-><init>(Landroidx/core/location/LocationManagerCompat$f;)V
    ...
    invoke-virtual {v0, p0, p1}, Landroidx/core/location/LocationManagerCompat$f;->c(J)V
...
.method public static getGnssHardwareModelName(Landroid/location/LocationManager;)Ljava/lang/String;
    ...
    invoke-static {p0}, Landroidx/core/location/LocationManagerCompat$d;->a(Landroid/location/LocationManager;)Ljava/lang/String;
...
.method public static getGnssYearOfHardware(Landroid/location/LocationManager;)I
    ...
    invoke-static {p0}, Landroidx/core/location/LocationManagerCompat$d;->b(Landroid/location/LocationManager;)I
...
.method public static isLocationEnabled(Landroid/location/LocationManager;)Z
    ...
    invoke-static {p0}, Landroidx/core/location/LocationManagerCompat$d;->c(Landroid/location/LocationManager;)Z
...
.method public static registerGnssStatusCallback(Landroid/location/LocationManager;Landroidx/core/location/GnssStatusCompat$Callback;Landroid/os/Handler;)Z
    ...
    invoke-direct {v0, p2}, Landroidx/core/location/LocationManagerCompat$i;-><init>(Landroid/os/Handler;)V
...
.method public static unregisterGnssStatusCallback(Landroid/location/LocationManager;Landroidx/core/location/GnssStatusCompat$Callback;)V
    ...
    sget-object v1, Landroidx/core/location/LocationManagerCompat;->b:Landroidx/collection/SimpleArrayMap;
    ...
    invoke-virtual {p1}, Landroidx/core/location/LocationManagerCompat$j;->b()V
    ...
    check-cast p1, Landroidx/core/location/LocationManagerCompat$h;

    if-eqz p1, :cond_4

    invoke-virtual {p1}, Landroidx/core/location/LocationManagerCompat$h;->b()V
